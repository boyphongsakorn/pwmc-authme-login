                ...
                <CardFooter>
                    {#if linkmcsuccess !== null && ismccrack !== null}
                        {#if linkmcsuccess === true}
                            {#if ismccrack === true}
                                คุณลิงก์บัญชีเกมแล้ว แต่บัญชีเกมของคุณเป็นบัญชี Crack จึงไม่สามารถดึงข้อมูลได้ ไม่ใช่? ลองเข้าเกมแล้วลิงก์บัญชีใหม่ หรือกดลิงก์<a on:click={toggle} class="text-primary">ที่นี่</a>
                            {/if}
                            {#if ismccrack === false}
