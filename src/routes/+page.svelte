...
<Container sm>
    <Row>
        ...
        <Col class="d-flex justify-content-center">
            <img src="https://img.gs/fhcphvsghs/640x360,crop=top/https://res.cloudinary.com/dstnfzzu4/image/upload/v1765002338/Screenshot_2568-12-06_at_13.22.01_mxaqzn.png" class="rounded-2 w-75 shadow my-2" alt="Map">
        </Col>
    </Row>
</Container>
<Container sm>
    <Row>
        <Col class="d-flex justify-content-center">
            <img src="https://img.gs/fhcphvsghs/640x360,crop=top/https://res.cloudinary.com/dstnfzzu4/image/upload/v1765002337/Screenshot_2568-12-06_at_13.22.10_x5jgxp.png" class="rounded-2 w-75 shadow my-2" alt="Chat">
        </Col>
        <Col class="text-center my-auto">
